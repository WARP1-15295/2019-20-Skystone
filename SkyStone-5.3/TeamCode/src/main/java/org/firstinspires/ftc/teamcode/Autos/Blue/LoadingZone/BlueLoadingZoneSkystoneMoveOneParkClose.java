 ...
 */
@Autonomous(name = "Blue Loading Zone Skystone Move One Park Close", group="Blue Loading Zone")
//@Disabled
public class BlueLoadingZoneSkystoneMoveOneParkClose extends LinearOpMode {
    ...
    while (!isStopRequested() && !opModeIsActive()) {
        ...
        while (opModeIsActive()) {
            if (skystonePosition == "left") {
                ...
                robotMap.dualMotorRunToDistance(robotMap.drivetrainLeft, robotMap.drivetrainRight, -14, -14, robotMap.MAX_AUTO_COURSE_POWER, 2.5);
                robotMap.singleMotorRunToDistance(robotMap.drivetrainCenter, -46.0,8.0);
                sleep(1000);
                robotMap.grabberLeftServo.setPosition(robotMap.GRABBER_RELEASE);
                robotMap.grabberRightServo.setPosition(robotMap.GRABBER_RELEASE);
                sleep(1500);
                robotMap.dualMotorRunToDistance(robotMap.drivetrainLeft, robotMap.drivetrainRight, -16.0, -16.0, robotMap.MAX_AUTO_COURSE_POWER, 2.5);
                ...
                robotMap.dualMotorRunToDistance(robotMap.drivetrainLeft, robotMap.drivetrainRight, -14, -14, robotMap.MAX_AUTO_COURSE_POWER, 2.5);
                robotMap.singleMotorRunToDistance(robotMap.drivetrainCenter, -46.0, 7.5);
                sleep(1500);
                robotMap.grabberLeftServo.setPosition(robotMap.GRABBER_RELEASE);
                robotMap.grabberRightServo.setPosition(robotMap.GRABBER_RELEASE);
                sleep(1500);
