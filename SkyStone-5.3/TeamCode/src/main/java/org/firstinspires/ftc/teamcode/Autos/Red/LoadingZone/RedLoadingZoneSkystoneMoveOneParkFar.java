 ...
 */
@Autonomous(name = "Red Loading Zone Skystone Move One Park Far", group="Red Loading Zone")
//@Disabled
public class RedLoadingZoneSkystoneMoveOneParkFar extends LinearOpMode {
