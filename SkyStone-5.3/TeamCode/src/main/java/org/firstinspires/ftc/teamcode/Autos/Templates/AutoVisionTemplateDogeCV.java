package org.firstinspires.ftc.teamcode.Autos.Templates;
 ...
 */
@Autonomous(name = "Auto Vision Template Doge.CV", group="Concept")
@Disabled
public class AutoVisionTemplateDogeCV extends LinearOpMode {
